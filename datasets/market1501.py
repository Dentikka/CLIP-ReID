...
class Market1501(BaseImageDataset):
    ...
    def __init__(self, root='', attributes_dir='', verbose=False, pid_begin = 0, **kwargs):
        ...
        self.num_train_pids, self.num_train_imgs, self.num_train_cams, self.num_train_vids = self.get_imagedata_info(self.train, has_annos=True)
